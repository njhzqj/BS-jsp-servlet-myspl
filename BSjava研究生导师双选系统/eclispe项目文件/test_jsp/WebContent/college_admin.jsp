...
<%
        ...
        out.print(current_college+" 学院的管理员 "+current_name+"，您好！<br>");
	    out.print("<br>");
	    
	    //查看学生信息按钮
	    String student_view_url=localUrl+"test_jsp/student_view.jsp?college="+current_college;
	    out.print("<a href=\""+student_view_url+"\"");
	    out.print("<br>");
	    out.print("<input type=button value=\"查看本院学生信息\" >");
	    out.print("</a>");
	    out.print("<br>");
	    
	    //查看老师信息按钮
	    String teacher_view_url=localUrl+"test_jsp/teacher_view.jsp?college="+current_college;
	    out.print("<a href=\""+teacher_view_url+"\"");
	    out.print("<br>");
	    out.print("<input type=button value=\"查看本院导师信息\" >");
	    out.print("</a>");
	    out.print("<br>");
	    
	    //增加学生按钮
	    String add_student_url=localUrl+"test_jsp/add_student.jsp?college="+current_college;
	    ...
	    //增加老师按钮
	    String add_teacher_url=localUrl+"test_jsp/add_teacher.jsp?college="+current_college;
